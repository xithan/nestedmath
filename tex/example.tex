...
% \newcommand{\pagehook}{\getroomnr{\roomname} \roomtitle{\roomname}}
% %\fancyhf{}
% \fancyhead{}
% \fancyfoot{}
% \fancyhead[LE,RO]{{\sffamily{\nouppercase\rightmark}}} %{{\sffamily \pagehook}}  %\slshape \righmark
% %\fancyhead[LO,RE]{\scshape }
% %\fancyhead[RE,LO]{\textit{\getroomnr{\roomname} \roomtitle{\roomname}}}
